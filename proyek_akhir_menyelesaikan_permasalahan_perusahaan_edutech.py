...
"""**Pertanyaan Utama dalam Proyek Ini:**

Apa saja faktor yang memengaruhi keputusan mahasiswa untuk berhenti kuliah (dropout)?

**Deskripsi Dataset yang Digunakan:**

* **Status Pernikahan**: Kategori status pernikahan mahasiswa, seperti Lajang, Menikah, Duda/Janda, Bercerai, Hidup bersama tanpa ikatan pernikahan resmi, atau Berpisah secara hukum.

* **Metode Pendaftaran**: Jalur atau cara mahasiswa mendaftar ke perguruan tinggi, contohnya Jalur umum fase pertama, Jalur khusus seperti Kepulauan Azores, Peraturan No. 612/93, dan lainnya.

* **Urutan Pendaftaran**: Prioritas pilihan program studi yang diajukan oleh mahasiswa, dinyatakan dalam angka dari 0 (pilihan utama) hingga 9 (pilihan terakhir).

* **Program Studi**: Jurusan atau program yang dipilih mahasiswa, seperti Teknologi Produksi Biofuel, Desain Animasi dan Multimedia, atau Pelayanan Sosial (kelas malam), dan lainnya.

* **Waktu Perkuliahan**: Jadwal kuliah mahasiswa, diklasifikasikan menjadi Kelas Pagi (1) dan Kelas Malam (0).

* **Kualifikasi Sebelumnya**: Tingkat pendidikan terakhir sebelum masuk kuliah, seperti Pendidikan Menengah, Sarjana, atau Magister.

* **Nilai Kualifikasi Sebelumnya**: Skor akademik dari jenjang pendidikan sebelumnya, dalam rentang 0–200.

* **Kewarganegaraan**: Negara asal mahasiswa, seperti Portugal, Jerman, Spanyol, dan sebagainya.

* **Pendidikan Orang Tua**: Tingkat pendidikan ibu dan ayah mahasiswa, mulai dari pendidikan menengah hingga pendidikan tinggi tingkat lanjut.

* **Pekerjaan Orang Tua**: Jenis pekerjaan ibu dan ayah, termasuk Mahasiswa, Pejabat Pemerintah, Profesional Intelektual, dan lainnya.

* **Nilai Masuk**: Skor yang digunakan sebagai dasar seleksi masuk perguruan tinggi, dengan skala 0–200.

* **Status Tambahan Mahasiswa**: Informasi lain terkait status mahasiswa, seperti:

  * Mahasiswa pindahan (1: Ya, 0: Tidak)
  * Berkebutuhan khusus (1: Ya, 0: Tidak)
  * Memiliki utang akademik (1: Ya, 0: Tidak)
  * Status pembayaran biaya kuliah (1: Lunas, 0: Tidak)
  * Jenis kelamin (1: Laki-laki, 0: Perempuan)
  * Penerima beasiswa (1: Ya, 0: Tidak)
  * Mahasiswa internasional (1: Ya, 0: Tidak)

* **Data Akademik Semester 1**: Informasi akademik pada semester pertama, meliputi:
...
* **Statistik Deskriptif (data.describe()):**
  Menampilkan ringkasan statistik kolom numerik, seperti rata-rata, standar deviasi, nilai minimum dan maksimum. Contohnya, kolom Admission\_grade rata-rata 127,3 dengan rentang 0–200.
